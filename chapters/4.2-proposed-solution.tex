...
\EB{Daniel, como você tem usado bastante o termo seismic operators, acho bom definí-lo na seção de background. Talvez seja bom deixar claro lá também o que você quer dizer com memory footprint.}
...
\begin{enumerate}
  \item \textbf{Algorithm-specific model:} train a model for each algorithm, considering \EBC{the seismic data's}{it's input parameters'} shape and size as the primary features for the prediction.
